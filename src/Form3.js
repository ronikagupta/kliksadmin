      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate>
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6}>
              <div style={{marginLeft:"-100%"}}> <b >Address<span style={{color:"red"}}>*</span></b>
              </div>
             <TextField
                autoComplete="fname"
                name="firstName"
            ...
            <Grid item xs={12} sm={6}>
            <div style={{marginLeft:"10%"}}> <b >Address2<span style={{color:"red"}}>*</span></b>
              </div>
              <TextField
                variant="outlined"
                required
                ...
                placeholder="Bingamon Road"
              />
            </Grid>
            <FormControl variant="outlined" className={classes.formControl}>
            <div> <b style={{marginLeft:"-230%",marginBottom:"-10%"}} >Country<span style={{color:"red"}}>*</span></b>
              </div>
        <InputLabel id="demo-simple-select-outlined-label"style={{marginLeft:"-220%",marginTop:"60%"}}>United State</InputLabel>
        <Select
        ...
        >
          ...
          <MenuItem value={30}>Thirty</MenuItem>
            ...
            <Grid item xs={12} sm={6}>
            <div style={{marginLeft:"80%"}}> <b >State<span style={{color:"red"}}>*</span></b>
              </div>
              <TextField
                autoComplete="fname"
                name="firstName"
            ...
            <Grid item xs={12} sm={6}>
            <div style={{marginLeft:"-100%"}}> <b >City<span style={{color:"red"}}>*</span></b>
              </div>
              ...
              <TextField
                ...
                placeholder="Bainbridge Township"
              />
            </Grid>
            <Grid item xs={12} sm={6}>
            <div style={{marginLeft:"10%"}}> <b >Zip Code<span style={{color:"red"}}>*</span></b>
              </div>
